...
data_drift_report = Report(metrics=[
    # DataDriftPreset(),
    # Parameter for DatasetDriftMetric: drift_share
    # DatasetDriftMetric(),
    ...
    DataDriftTable(num_stattest='t_test', num_stattest_threshold=0.05, cat_stattest='chisquare', cat_stattest_threshold=0.05),
